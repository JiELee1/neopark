...
public class TestUtil {
	...
	public static Musical createMusical(String title, String description, LocalDate startDate, LocalDate endDate,
		String thumbnailUrl, ViewRating viewRating,
	...
	public static User createUser(SocialType socialType, String socialId, String nickname, UserRole role,
		boolean isDeleted, LocalDate birth, String email) {
	...
	public static ScheduleSeat createScheduleSeat(boolean isReserved, Seat seat, SeatGrade seatGrade,
		Schedule schedule) {
