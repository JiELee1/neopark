...
class ScheduleServiceTest {
	...
	void findScheduleSeatsSuccess() {
		...
		try (MockedStatic<ScheduleSeatResponseDTO> scheduleSeatResponseDTO = mockStatic(
			ScheduleSeatResponseDTO.class)) {
			...
			scheduleSeatResponseDTO.verify(() -> ScheduleSeatResponseDTO.from(any(ScheduleSeat.class)),
				times(scheduleSeats.size()));
		}
	}
